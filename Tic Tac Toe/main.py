...
BOARD_IMAGE = pygame.image.load(r"assets/board.png")
ICON_IMAGE = pygame.image.load(r"assets/icon.png")
PLAYER_1 = pygame.image.load(r"assets/X.png")
PLAYER_2 = pygame.image.load(r"assets/O.png")
...
def display_player_name(screen, player1_turn, game_over, tie):
    if tie:
        ...
        if game_over:
            text_surface = FONT.render(f"{PLAYER1_NAME} wins!", False, (0, 0, 0))
        else:
            text_surface = FONT.render(f"{PLAYER1_NAME}'s turn", False, (0, 0, 0))
    else:
        if game_over:
            text_surface = FONT.render(f"{PLAYER2_NAME} wins!", False, (0, 0, 0))
        else:
            text_surface = FONT.render(f"{PLAYER2_NAME}'s turn", False, (0, 0, 0))
